...
public class Game extends JPanel{
    ...
    final static String IMAGE_DIR = "./src/main/resources/images/";
    ...
    public Game(){
        ...
        car_x = 0;
        car_y = 224;    //initialling setting the user's car location to (300,300)
    ...
    public void paint(Graphics g){
        ...
        try{
            obj.drawImage(getToolkit().getImage(IMAGE_DIR + "st_road.png"), 0, 0 ,this); //draw road on window
            if(cry >= -499 && crx >= -499) //if a road crossing has passed the window view
                obj.drawImage(getToolkit().getImage(IMAGE_DIR + "cross_road.png"),crx,cry,this); //draw another road crossing on window
            
            obj.drawImage(getToolkit().getImage(IMAGE_DIR + "car_self.png"),car_x,car_y,this);   //draw car on window
            
            if(isFinished){ //if collision occurs
                obj.drawImage(getToolkit().getImage(IMAGE_DIR + "boom.png"),car_x-30,car_y-30,this); //draw explosion image on window at collision to indicate the collision has occured
            }
    ...
    public static void main(String args[]) throws AWTException {
        ...
        while(true){
            ...
            if(game.nOpponent < 4 && count % 200 == 0){ //if there is less than 4 cars and count timer reaches 200
                game.imageLoc[game.nOpponent] = IMAGE_DIR + "car_left_" +((int)((Math.random()*100)%3)+1)+".png"; //assign images to the opponent cars
    ...
    private void runDriver() throws AWTException {
